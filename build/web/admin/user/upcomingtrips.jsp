                            ...
                            <div class="content table-responsive table-full-width">
                                <s:if test="#att.upcoming_tickets.size()>0">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            <s:iterator value="#attr.upcoming">
                                                <tr>
                                                    ...
                                                    <td><i class="pe-7s-trash" style="font-size: 1.5em;"></i></td>
                                                </tr>
                                ...
                                <s:else>
                                    <p class="content">You have no upcoming trips.</p>
